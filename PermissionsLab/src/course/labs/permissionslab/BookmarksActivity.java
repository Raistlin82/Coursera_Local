...
public class BookmarksActivity extends Activity {
	...
	private void startGoToDangerousActivity() {
		...
		Intent startGoToDangerousActivityIntent = new Intent(BookmarksActivity.this, GoToDangerousActivity.class);
		this.startActivity(startGoToDangerousActivityIntent);
